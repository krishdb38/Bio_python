...
in_path =  "/mnt/d/Preterm_Hospital/PASS_VCF_Only/New/"
# Old 20 and new 40 are different
out_path = "/mnt/d/Preterm_Hospital/PASS_VCF_Only/Annovar_result/"
...
files = ['MWB_746','MWB_815','MWB_870','MWB_895','MWB_911','MWB_941','MWB_956','MWB_961']


for _ in files:
    vcf_file = in_path+ str(_)+".PASS.vcf"
